...
const ContactPage = () => {
  return (
    <div className="min-h-screen md:h-[380vh]">
      <div className="md:h-[740px] h-[900px] bg-[#eee6da] md:pt-[14em] pt-[10em] md:px-28 px-10 flex md:flex-row flex-col">
        <div className="flex-1">
          <h1 className="md:text-7xl text-6xl tracking-wider text-[#5c6a55]">Contact</h1>
      ...
      <div className="h-[330px] bg-[#eee6da] flex flex-col items-center justify-center">
        ...
        <a href="https://www.instagram.com/zen.healing.reiki/" target="_blank" className="text-[#5c6a55] text-2xl text-center w-full tracking-wider leading-tight font-regular pt-6">@zen.healing.reiki</a>
      </div>
    </div>
  );
};

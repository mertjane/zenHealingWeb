...
const AboutPage = () => {
  return (
    <div className="md:h-[220vh] h-[190vh] ">
            ...
            <StaggerAnimation staggerDelay={0.3} childDelay={0.5}>
              ...
              <StaggerItem>
                <p className="text-gray-600 tracking-wider md:text-2xl text-xl font-thin">
                  I'm Ezgi, a Reiki Master and healer with a lifelong
                  sensitivity to energy and emotion. My journey into Reiki began
                  during a challenging time, when a single session brought
                  profound peace and clarity. That moment sparked a deep calling
                  to help others heal. <br />
                  <br /> Inspired by my great-grandmother, a natural healer.
                  I’ve continued her legacy through hands-on energy work,
                  completing Reiki Levels I, II, and Master certification.
                  Today, I offer sessions grounded in compassion, intuition, and
                  the belief that we all hold the power to heal. Reiki is more
                  than a practice, it’s who I am. It’s an honour to walk this
                  path with those seeking balance, peace, and transformation.{" "}
                  <br />
                  <br /> With gratitude and light,
                </p>
              </StaggerItem>
            </StaggerAnimation>
          </ParallaxScroll>
